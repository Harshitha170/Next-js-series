...
const Loginform = () => {
  return (
    ...
    <div className='mt-5'>
      <label className='block text-sm font-medium text-grau-700'>Password</label>
    ...
    <button type="submit" className='mt-3 w-full flex-justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medim text-white bg-blue-600 hover:bg-blue-700 border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm p-2'>Login
